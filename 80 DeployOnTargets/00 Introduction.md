...
This should be a softlink by LabVIEW to link to `/home/lvuser/natinst/bin/`.
...
For the TMA and AUX PXIs, do `ln -s /usr/local/lib /c/ni-rt/system` to do the softlink of libraries.
