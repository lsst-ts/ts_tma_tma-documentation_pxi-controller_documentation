...
![Server.lvclass_Process.vi block diagram\label{serverProcessBlockDiagram}](../DocResources/f8028a78c1fca2eaaca83ba905948bed.png)
...
![Server.lvclass_Server_Init.vi context help](../DocResources/EcCPdfAWEbtGoMtXXAdPFaPJevPCiXiCfBNy_ContextHelp.png)

###### CleanUp

Stop the process

![Server.lvclass_CleanUp.vi context help.](../DocResources/EvEhyRNExbMFGbHgBZQsiyNnLrhOWagfsxeQ_ContextHelp.png)
...
![Server.lvclass_ControlProcessWindow.vi context help.](../DocResources/WFlJTYPARqUYsLnrFjvgLNsQygNvEnnUnmfV_ContextHelp.png)
...
![Server.lvclass_SendDataTCP.vi context help.](../DocResources/KGOIjKIOZWctWXLXsxtMEigEvSttyRPMJVTC_ContextHelp.png)

###### SendDataTCP2All

Send the specified TCP message to all the connected TCP clients.

![Server.lvclass_SendDataTCP2All.vi context help.](../DocResources/FafWNqLsLEHBYaqTqRjZXYRQRYxKqFfoHssS_ContextHelp.png)
...
![Server.lvclass_Process.vi Init](../DocResources/b2778629528983275c632aeb660a7abf.png)
...
![Server.lvclass_Process.vi Idle](../DocResources/25dcf81b8d5d34d86edc9c07a79a5ba5.png)
...
![Timeout state from Idle state](../DocResources/1e2f937dc618605c620b5684a5813697.png)

![Server.lvclass_Process.vi Timeout](../DocResources/69c63cb7d417cfaee3a8fe4ce37ca62b.png)

###### ShowWindow

This state is used to show the front panel of the process.

![Server.lvclass_Process.vi ShowWindow](../DocResources/e69d2d974ee18af4bb649e21db92269b.png)

###### HideWindow

This state is used to hide the front panel of the process.

![Server.lvclass_Process.vi HideWindow](../DocResources/4804276518cb9f6e2c8f0ccbdc7abf31.png)
...
![Server.lvclass_Process.vi CMD-SendData](../DocResources/e0202f4c7bf706a3832d5c7f249edaf8.png)
...
![Server.lvclass_Process.vi CMD-SendData2All](../DocResources/282ae05422f613021acaa33990a5dfe6.png)
...
![Server.lvclass_Process.vi shutdown](../DocResources/8f7648965940c4b510535f139760476f.png)
...
![Server.lvclass_Process.vi Error](../DocResources/483f07d3417caa5b5d10d4a632d8007a.png)
...
![Server.lvclass_Process.vi Initialize](../DocResources/4828deb415a8db418cf241a49de04305.png)
...
![Server.lvclass_Process.vi StatusCheck](../DocResources/d0f96d781471d52ca329ae714ef90ea8.png)
...
![Server.lvclass_Process.vi ListenCommands](../DocResources/1ef67b0e32d52d5f7fe352ceb4f5021e.png)
...
![Server.lvclass_Process.vi ErrorHandling](../DocResources/6ed8dc820a53171f26c2d9f561b50fbb.png)
...
![Server.lvclass_Process.vi Exit](../DocResources/8c9139f780eb476e4bed4698b627e0eb.png)
...
![Server.lvclass_Process.vi Initialize](../DocResources/21bfef6d77132753e4aa803f07fa1471.png)
...
![Server.lvclass_Process.vi WaitNewConnection](../DocResources/761bd38beb5a1a21ffa6d9bd66be0f0b.png)
...
![Server.lvclass_Process.vi CheckExit](../DocResources/072bbdd1544aa5c10b23f8a2e7b027de.png)
...
![Server.lvclass_Process.vi ErrorHandling](../DocResources/e1a3df95a7639cf916416c6fb1e5455e.png)
...
![Server.lvclass_Process.vi Exit](../DocResources/1d95653b306ff02f78c047350ec21c8f.png)
